...
bool Level::init(XMLElement * pElement)
{
	...
	IF_NULL_RETURN_FALSE(pElement->Attribute("exit_col")) ;
	m_exitCol = atoi(pElement->Attribute("exit_col"));

	IF_NULL_RETURN_FALSE(pElement->Attribute("exit_row")) ;
	m_exitRow = atoi(pElement->Attribute("exit_row"));
